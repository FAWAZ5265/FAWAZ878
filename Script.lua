...
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك تقييد الشيخ فواز  ؛") 
...
return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تقييد الشيخ فواز  ؛") 
...
elseif UserID == 1619524486 or UserID == 2034770645 then 
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك طرد الشيخ فواز ؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1619524486 or UserID == 2034770645 then 
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك حظر الشيخ فواز  ؛") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1619524486 or UserID == 2034770645 then 
return sendMsg(arg.ChatID,arg.MsgID,"- لا يمكنك كتم الشيخ فواز  ؛") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
if UserID == 1619524486 or UserID == 2034770645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد الشيخ فواز  \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 2034770645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد الشيخ فواز  ") end
NameUser = Hyper_Link_Name(data)
...
local text = " [الشيخ فواز 🌐 ](t.me/bbqq8)"
local inline = {
{{text = '-𝙳𝙴𝚅 👑',url="https://t.me/TFTUT"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local text = " اهلا وسهلا بك بسورس حمد ⩫ "
local inline = {
{{text = 'سـورس حـمـد ⩫ ',url="https://t.me/tft4t"}},
{{text = 'المـطور',url="https://t.me/TFTUT"}},
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل الشيخ فواز  ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 2034770645then 
return sendMsg(ChatID,MsgID,"- لا يمكنك حظر الشيخ فواز  ؛") 
end
if redis:sismember(boss..'bannedpv',UserID) then 
...
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر الشيخ فواز  ؛") 
end
...
if msg.adduser == 1619524486 or msg.adduser ==  2034770645 then 
gtupe = 'الشيخ فواز ' 
...
elseif Text== "الشيخ فواز" or Text== "مطور حمد" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[الشيخ فواز](T.ME/bbqq8)")
...
return sendMsg(msg.chat_id_,msg.id_,"مطوري المحزم المليان")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"المنشئ تاج راسي")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"مدير المجموعه الهيبه")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"ادمن ومسوي فيها يعني؟")
else 
return sendMsg(msg.chat_id_,msg.id_,"تيس")
end 
end 
